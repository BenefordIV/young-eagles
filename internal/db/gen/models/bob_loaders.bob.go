...
type preloaders struct {
	Child  childPreloader
	Flight flightPreloader
	Pilot  pilotPreloader
	Plane  planePreloader
}

func getPreloaders() preloaders {
	return preloaders{
		Child:  buildChildPreloader(),
		Flight: buildFlightPreloader(),
		Pilot:  buildPilotPreloader(),
		Plane:  buildPlanePreloader(),
	}
}
...
type thenLoaders[Q orm.Loadable] struct {
	Child  childThenLoader[Q]
	Flight flightThenLoader[Q]
	Pilot  pilotThenLoader[Q]
	Plane  planeThenLoader[Q]
}

func getThenLoaders[Q orm.Loadable]() thenLoaders[Q] {
	return thenLoaders[Q]{
		Child:  buildChildThenLoader[Q](),
		Flight: buildFlightThenLoader[Q](),
		Pilot:  buildPilotThenLoader[Q](),
		Plane:  buildPlaneThenLoader[Q](),
	}
}
