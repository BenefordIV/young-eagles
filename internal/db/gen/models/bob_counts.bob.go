...
type preloadCounts struct {
	Child childCountPreloader
	Pilot pilotCountPreloader
	Plane planeCountPreloader
}

func getPreloadCount() preloadCounts {
	return preloadCounts{
		Child: buildChildCountPreloader(),
		Pilot: buildPilotCountPreloader(),
		Plane: buildPlaneCountPreloader(),
	}
}

type thenLoadCounts[Q orm.Loadable] struct {
	Child childCountThenLoader[Q]
	Pilot pilotCountThenLoader[Q]
	Plane planeCountThenLoader[Q]
}

func getThenLoadCount[Q orm.Loadable]() thenLoadCounts[Q] {
	return thenLoadCounts[Q]{
		Child: buildChildCountThenLoader[Q](),
		Pilot: buildPilotCountThenLoader[Q](),
		Plane: buildPlaneCountThenLoader[Q](),
	}
}
